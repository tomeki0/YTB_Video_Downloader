...
class YouTubeDownloaderGUI:
    ...
    def show_settings(self):
        ...
        settings_window.geometry("450x370") 
        ...
        def center_window(window):
            window.update_idletasks()  # Atualizar geometria
        ...
        ctk.CTkLabel(main_frame, text="Links gerar em paralelo:", font=("Arial", 10)).grid(
        ...
        ctk.CTkLabel(main_frame, text="Vídeos baixar em paralelo:", font=("Arial", 10)).grid(
